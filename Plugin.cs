...
{
    [BepInPlugin("kylethescientist.zlothy.walksimulator", "WalkSimulator", "1.0.4")]
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Start()
        {
            ...
            PhotonNetwork.LocalPlayer.SetCustomProperties(
                    new
                            Hashtable() //I know technically your not allowed to do this anymore, BUT it's the only way to differentiate this legal one from all the other illegal ones.
                            {
